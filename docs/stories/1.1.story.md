...
│   ├── stripe/                        # Stripe integration (Epic 3)
...
# ============================================
# STRIPE (Epic 3 - Payment Integration)
# ============================================
...
- `/lib` - Utility and service modules (auth, llm, stripe, etc. added in later stories)
...
- `/lib/stripe/` - Stripe integration (future)
