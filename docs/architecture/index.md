...
- [TowerOfBabel - Fullstack Architecture Document](#table-of-contents)
  ...
  - [4. Data Models](./4-data-models.md)
    ...
    - [Model 4: StripeEvent (NEW - Idempotency)](./4-data-models.md#model-4-stripeevent-new-idempotency)
  ...
  - [6. Components](./6-components.md)
    ...
    - [Component 5: Stripe Integration Service](./6-components.md#component-5-stripe-integration-service)
  ...
  - [7. External APIs](./7-external-apis.md)
    ...
    - [Stripe API](./7-external-apis.md#stripe-api)
